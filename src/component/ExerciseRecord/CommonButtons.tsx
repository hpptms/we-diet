  ...
  <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
    ...
    <Button
      ...
      sx={{
        ...
        color: '#fff',
        boxShadow: '0 2px 8px 0 rgba(250,112,154,0.10)',
        transition: 'transform 0.1s, box-shadow 0.1s',
        height: 40,
        '&:hover': {
          background: 'linear-gradient(90deg, #fee140 0%, #fa709a 100%)',
          transform: 'scale(1.05)',
          boxShadow: '0 4px 16px 0 rgba(250,112,154,0.18)',
        },
      }}
      onClick={() => onAdd(1)}
    >
  ...
  <Box sx={{ display: 'flex', gap: 1, mt: 1 }}>
    <Button
      ...
      sx={{
        ...
        '&:hover': {
          ...
          transform: 'scale(1.05)',
          boxShadow: '0 4px 16px 0 rgba(67,206,162,0.18)',
        },
      }}
      onClick={() => onAdd(1)}
    >
    ...
    <Button
      ...
      sx={{
        ...
        '&:hover': {
          ...
          transform: 'scale(1.05)',
          boxShadow: '0 4px 16px 0 rgba(247,151,30,0.18)',
        },
      }}
      onClick={() => onAdd(10)}
    >
    ...
    <Button
      ...
      sx={{
        ...
        color: '#fff',
        boxShadow: '0 2px 8px 0 rgba(255,88,88,0.10)',
        transition: 'transform 0.1s, box-shadow 0.1s',
        height: 40,
        '&:hover': {
          background: 'linear-gradient(90deg, #f09819 0%, #ff5858 100%)',
          transform: 'scale(1.05)',
          boxShadow: '0 4px 16px 0 rgba(255,88,88,0.18)',
        },
      }}
      onClick={() => onAdd(60)}
    >
