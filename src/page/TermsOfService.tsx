  ...
  return (
    <>
      ...
      <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto', lineHeight: '1.6' }}>
        ...
        <p>{t('pages', 'termsOfService.lastUpdated')} {new Date().toLocaleDateString(language === 'ja' ? 'ja-JP' : language === 'ko' ? 'ko-KR' : language === 'zh-CN' ? 'zh-CN' : language === 'es' ? 'es-ES' : language === 'pt' ? 'pt-BR' : 'en-US')}</p>
        ...
        <p>{t('pages', 'termsOfService.contactContent')}<br/>{t('pages', 'termsOfService.contactEmail')}</p>
